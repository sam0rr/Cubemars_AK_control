...
// SET ORIGIN MODE - #5
// The setting command is uint8_t type, 0 means setting the temporary origin (power failure
// elimination) 1 means setting the permanent zero point (automatic parameter saving) 2 means
// restoring the default zero point (automatic parameter saving)
